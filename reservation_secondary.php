...
<html>
    <head>
        ...
        <style>
            ...
            .room-filter-row .visit-period label{
                font-family: "Verdana" ;
                font-size: 10pt;
                text-align: left;
                padding: 2px;
            ...
            .room-filter-row .visit-period input{
                width: 100%;
                border-radius: 10%;
                text-align: center;
    ...
    <body>
        ...
        <div class="container-fluid room_container">
           <div class="row room-filter-row">
            ...
            <div class="col-sm-12 col-lg-8 mx-auto room-page-wrapper">
                ...
                <div class="col-sm-12 mx-auto room-slider-wrapper" id="r_wrapper">
                	...
                	?>
                		...
                		<form class="select_room_form_data" action="reservation_newclient.php" method="POST">
        ...
        <script type="text/javascript" src="js_scripts\noAccountRes\roomFilter.js">
        </script>
   		        
        <script src="js_scripts\noAccountRes\sliderHandler.js">                    
        </script>       
    </body>
