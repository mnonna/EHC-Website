    ...
    <html>
        ...
        <body>
            ...
            <div class="container_users">
            		<h1 style="font-family: 'Rockwell'">Użytkownicy systemu</h1></br>           		
            		<table class="table_u table table-bordered table-dark table-hover" id="users">
            		<tr>
          				<th>ID</th>
          				<th>Nazwa</th>
          				<th>E_mail</th>
            ...
            <div class="staff_errors">
            	<h3><?php 
            	       if(isset($_SESSION['user_delete_perm_error']))
            	           echo $_SESSION['user_delete_perm_error'];
                       if(isset($_SESSION['user_self_delete_error']))
                           echo $_SESSION['user_self_delete_error'];
            	     ?>
           		</h3>
            </div>
        ...
        <script src="js_scripts\users\usersShow.js">
        </script>
